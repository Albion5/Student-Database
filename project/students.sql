...
CREATE TABLE public.courses (
    course_id integer NOT NULL, course character varying(100) NOT NULL
);
...
CREATE TABLE public.majors (
    major_id integer NOT NULL, major character varying(50) NOT NULL
);
...
CREATE TABLE public.majors_courses (
    major_id integer NOT NULL, course_id integer NOT NULL
);
...
CREATE SEQUENCE public.majors_major_id_seq AS integer START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.students (
    student_id integer NOT NULL, first_name character varying(50) NOT NULL, last_name character varying(50) NOT NULL, major_id integer, gpa numeric(2, 1)
);
